...
:heavy_check_mark: | :snail: v3.0.0 | NVIDIA | [grin-miner](https://github.com/mimblewimble/grin-miner) | Grin (AMD limited to a single GPU)
...
:heavy_check_mark: | :link: v16.0.7 | AMD NVIDIA | [bminer](https://www.bminer.me/) | Equihash, EtHash, Bytom, Grin
...
:heavy_check_mark: | :rocket: | AMD NVIDIA | [gminer](https://bitcointalk.org/index.php?topic=5034735.0) | AE, BFC, Grin, EtHash
