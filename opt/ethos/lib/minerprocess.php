...
// 	        }
	...
	$miner_path['xcash-amd'] = "/usr/bin/screen -c /opt/ethos/etc/screenrc.xcash-amd -l -L -dmS xcash-amd /opt/miners/xcash-amd/XCASH_AMD_Miner";
    ...
    if(intval(trim(file_get_contents("/opt/ethos/etc/allow.file"))) == 0) {
		...
		$miner_params['xcash-amd'] = $flags ." ". $pools;
		...
		$miner_suffix['xcash-amd'] = " ". $mine_with ." ". $extraflags;
